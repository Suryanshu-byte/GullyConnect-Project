...
export default function SignUpPage() {
  ...
  return (
    <motion.div
      ...
      className={`flex h-screen font-sans transition-all duration-500 ${darkMode ? "bg-[#0f172a] text-white" : "bg-gradient-to-br from-[#ffe7d9] via-[#fff2cc] to-[#d4fc79] text-gray-900"}`}
    >
      <div
      ...
      <div className={`w-1/2 flex items-center justify-center ${darkMode ? "bg-[#1e293b]" : "bg-gradient-to-br from-[#f9fafb] via-[#fce7f3] to-[#e0f2fe]"}`}>
        <div className={`w-full max-w-md rounded-3xl shadow-2xl ${darkMode ? "bg-[#334155] text-white" : "bg-white text-gray-800"} p-10`}>
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <input placeholder="Name" className="rounded-full px-4 py-2 bg-gray-100 text-gray-800 placeholder-gray-500 shadow-inner" />
              <input placeholder="Email Address" className="rounded-full px-4 py-2 bg-gray-100 text-gray-800 placeholder-gray-500 shadow-inner" />
              <input placeholder="Password" type="password" className="rounded-full px-4 py-2 bg-gray-100 text-gray-800 placeholder-gray-500 shadow-inner" />
            ...
            <div className="flex items-center gap-2 text-sm text-gray-600">
              ...
              <label htmlFor="terms">
                I agree <a href="#" className="underline text-pink-400">Terms of Service</a> and <a href="#" className="underline text-pink-400">Privacy Policy</a>
              </label>
            </div>

            <button className="w-full bg-gradient-to-r from-[#14b8a6] to-[#3b82f6] text-white font-bold rounded-full py-3 shadow-lg hover:scale-105 transition-transform">
              Sign Up
            </button>
          </div>
        </div>
